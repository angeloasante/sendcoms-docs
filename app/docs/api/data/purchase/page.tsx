...
const codeExamples: Record<Language, string> = {
  ...
  -d '{
    ...
    "capacity_gb": 1,
    "reference": "order-123",
    "idempotency_key": "unique-purchase-id-123",
    "metadata": {
      "user_id": "usr_abc123",
      "order_id": "ord_xyz789"
    }
        ...
        <div className="border border-white/10 rounded-lg overflow-hidden">
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-white/5">
              ...
              <tr className="bg-[#0b0c0e]">
                <td className="py-3 px-4 text-sm text-green-400 font-mono">idempotency_key</td>
                <td className="py-3 px-4 text-xs text-gray-400">string</td>
                <td className="py-3 px-4"><span className="bg-gray-500/10 text-gray-400 px-2 py-0.5 rounded text-xs border border-gray-500/20">Optional</span></td>
                <td className="py-3 px-4 text-sm text-gray-400">Unique key to prevent duplicate purchases (24h TTL)</td>
              </tr>
            </tbody>
          </table>
        </div>
